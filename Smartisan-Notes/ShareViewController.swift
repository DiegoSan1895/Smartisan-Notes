...
class ShareViewController: UIViewController {
    ...
    func dealWithShare(sender: UIButton) {
        ...
        case 1:
            ...
            let weiboMessage = MonkeyKing.Message.Weibo(.Default(info: (title: "分享Smartisan-Notes",
                description: "我安装了锤子科技（Smartisan）出品的 iOS 版锤子便签。锤子科技自己认为这可能是史上最漂亮的便签类应用。该应用可将文字生成版式优美的图片长微博。苹果手机用户可到 App Store 下载，下载地址：\(AppItunsURL.notesURL)",
                thumbnail: nil,
                media: .Image(UIImage(named: "note_share_image")!)
