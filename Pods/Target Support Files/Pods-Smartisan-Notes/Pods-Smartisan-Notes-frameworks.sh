...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Smartisan-Notes/MagicalRecord.framework"
  install_framework "Pods-Smartisan-Notes/MonkeyKing.framework"
  install_framework "Pods-Smartisan-Notes/Proposer.framework"
  ...
  install_framework "Pods-Smartisan-Notes/YYKit.framework"
fi
